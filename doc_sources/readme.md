...
3D level-set method for high-resolution electron tomography
...
* Documentation: [https://ajinkyakadu125.github.io/levelset]
...
- [ ] A conda package
    ...
    - The installation instructions (below) have been updated. Do not
      ...
      some-other-channel`, and your own channel, e.g., `-c ajinkyakadu125`.


## Getting Started

It takes a few steps to setup LevelSet on your
...
Simply install with:
```
conda install -c cicwi levelset
```

### Installing from source

To install LevelSet, simply clone this GitHub
project. Go to the cloned directory and run PIP installer:
```
git clone https://github.com/ajinkyakadu125/levelset.git
cd levelset
pip install -e .
```
...
See also the list of [contributors](https://github.com/ajinkyakadu125/levelset/contributors) who participated in this project.
